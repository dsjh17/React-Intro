...
//Styling is from tailwind.css utility first fundametals
        ...
        <div className="text-center space-y-5 sm:text-left">
          <div className="-space-y-1">
            ...
            <p className="text-slate-500 font-medium">
              {props.role ? props.role : "Unemployed"}
            </p>
          </div>
          <EditEmployee
          id={props.id}
